        ...
        <div className="space-y-6 text-ink-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-1 space-y-1">
              ...
              <li><strong>Ежемесячной подписки</strong> — доступ к определённому количеству проверок в месяц на условиях автоматического продления (условия и тарифные планы подписки описаны на странице <Link href="/pricing" className="text-brand hover:text-brand-hover">ai-compliance.online/pricing</Link>).</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              4.4. Разовая покупка отчёта не предполагает автоматического продления и не создаёт повторных списаний. Ежемесячная подписка продлевается автоматически каждый месяц до тех пор, пока Заказчик не откажется от неё (отмена подписки происходит в личном кабинете Сервиса).
            </p>
          </section>
