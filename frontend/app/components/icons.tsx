// Простые line-иконки (24x24, stroke=currentColor) — без внешних зависимостей,
// заменяют эмодзи-иконки из старого дизайна.
...
export function IconSmartphone({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
